...
export function Testimonials() {
    ...
    return <section className="testimonials-section" id="neighbors"><div className="wrap"><div className="testimonials-heading"><div><p className="eyebrow">05 / WORD AROUND THE MOUNTAINS</p><h2>Good work gets around.</h2></div><button className="text-link" onClick={() => { setSuccess(false); setOpen(true); }}>Have a code? Leave a kind word <ArrowUpRight size={17}/></button></div>
